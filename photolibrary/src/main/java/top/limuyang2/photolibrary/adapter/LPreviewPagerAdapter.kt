 ...
 * @author limuyang
 */
internal class LPreviewPagerAdapter(manager: FragmentManager, private val list: List<Uri>) : FragmentStatePagerAdapter(manager, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
